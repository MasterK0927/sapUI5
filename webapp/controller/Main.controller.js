sap.ui.define([
    ...
    "testApp/model/models" // assuming models.js is in the same directory
    ...
    return Controller.extend("testApp.controller.Main", {
        onInit: function() {
            ...
            // model2
            var oModel2 = models.createJSONModel("model/mockdata/sample2.json"); // using the model factory function
